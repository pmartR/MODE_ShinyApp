make_front_page_plot_opts <- function(){
  div(id = "front_page_plot_opts",
    ...
    checkboxGroupButtons("WantGroups", "Would you like to assign groups?", c("Yes", "No"), "No"),
    uiOutput("GroupDesignationUI"),
    checkboxGroupButtons("IsTransformed", "Is your data log transformed?", c("Yes", "No"), "No"),
    uiOutput("SelectTransformationUI"),
    checkboxGroupButtons("IsNormalized", "Is your data normalized?", c("Yes", "No"), "No"),
